...
class CalcVM: ObservableObject {
    ...
    func handleKeyPress(key: Key) {
        if key.keyType == KeyType.Operator {
    ...
    func getKeys() -> [[Key]] {
        ...
        return [[
                ...
                Key(label: cancel, color: Color("HOperatorColor"), labelColor: Color.white),
                Key(label: "+/-", color: Color("HOperatorColor"), labelColor: Color.white, keyType: .Operator),
                Key(label: "%", color: Color("HOperatorColor"), labelColor: Color.white, keyType: .Operator),
                Key(label: "/", color: Color("VOperatorColor"), labelColor: Color.white, keyType: .Operator)
            ],
            [
                Key(label: "7"),
                Key(label: "8"),
